...
void GameServer::UpdateServer() {
	...
	while (enet_host_service(netHandle, &event, 0) > 0) {
		...
		if (type == ENetEventType::ENET_EVENT_TYPE_CONNECT) std::cout << "Server: New client connected\n";
		else if (type == ENetEventType::ENET_EVENT_TYPE_DISCONNECT) std::cout << "Server: A client has disconnected\n";
