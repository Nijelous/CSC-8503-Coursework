...
namespace NCL {
	...
	public:
		...
		static Vector3 GreatestAxis(const Vector3& axis);

		static Vector4 OBBTest(const Vector3& posA, const Vector3& posB, const Vector3& halfSizeA, const Vector3& halfSizeB,
